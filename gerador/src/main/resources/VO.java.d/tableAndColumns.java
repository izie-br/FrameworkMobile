...
#**##end
#**#    public final static Table.Column<${field.Klass}> ${field.UpperAndUnderscores} =
#******#        _TABLE.addColumn(${field.Klass}.class,
...
#******#    public final static Table _${association.JoinTableUpper} =
#******#        new Table (
