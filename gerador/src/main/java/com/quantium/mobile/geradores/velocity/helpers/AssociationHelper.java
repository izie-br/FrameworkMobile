...
//					o2mObj.setForeignKey(newProperty);
    ...
    public static class AssociationHolder {
        private ArrayList<OneToManyAssociationHelper> manyToOne;
        private ArrayList<OneToManyAssociationHelper> oneToMany;
        private ArrayList<ManyToManyAssociationHelper> manyToMany;

        public ArrayList<ManyToManyAssociationHelper> getManyToMany() {
            return manyToMany;
        }
        ...
        public ArrayList<OneToManyAssociationHelper> getManyToOne() {
            return manyToOne;
        }

        public void setManyToOne(ArrayList<OneToManyAssociationHelper> manyToOne) {
            this.manyToOne = manyToOne;
        }

        public ArrayList<OneToManyAssociationHelper> getOneToMany() {
            return oneToMany;
        }

        public void setOneToMany(ArrayList<OneToManyAssociationHelper> oneToMany) {
