...
//            ) + column.getName();
        ...
        return
                ...
                (column.getKlass().equals(Date.class)) ?
                        ...
                        SQLiteUtils.dateTimeForColumnForSelect(columnNameWithTable) :
                        // se nao, apenas o nome
                        columnNameWithTable;
    }

    @Override
    protected String getColumnForWhere(String tableAs, Table.Column<?> column) {
        // Eh bom reforcar o uso de "alias" para tabelas em um ORM
//        String columnNameWithTable =
//            (
//                (tableAs != null) ?
...
//            ) + column.getName();
        ...
        return
                ...
                (column.getKlass().equals(Date.class)) ?
                        // se eh date, buscar por "datetime(coluna)"
                        SQLiteUtils.dateTimeForColumnForWhere(columnNameWithTable) :
                        // se nao, apenas o nome
                        columnNameWithTable;
    }
}
